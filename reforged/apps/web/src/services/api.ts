import type { AugmentDef, BoardPosition, CombatLog, LeaderboardEntry, RunState, Side, Tag, UnitDef, UserProfile } from '@reforged/schema';
...
export const api = {
  ...
  getLeaderboard: () => request<LeaderboardEntry[]>('GET', '/api/leaderboard'),
