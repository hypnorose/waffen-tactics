...
| alyson_stark | 3 | fighter | 66.7% | 59.5% | 90 | **overpowered** | review for a nerf after system rules are normalized |
...
| beudzik | 2 | fighter | 60.0% | 52.0% | 100 | **healthy** | keep values and monitor after system-rule fixes |
| bosman | 1 | fighter | 80.0% | 48.7% | 100 | **overpowered** | review for a nerf after system rules are normalized |
| buba | 2 | fighter | 75.0% | 50.5% | 100 | **overpowered** | review for a nerf after system rules are normalized |
| capybara | 3 | duelist | 88.9% | 52.3% | 90 | **overpowered** | review for a nerf after system rules are normalized |
...
| dumb | 1 | duelist | 100.0% | 48.0% | 100 | **overpowered** | review for a nerf after system rules are normalized |
| falconbalkon | 2 | fighter | 70.0% | 40.2% | 100 | **overpowered** | review for a nerf after system rules are normalized |
| fiko | 4 | defender | 25.0% | 53.4% | 80 | **underpowered** | review for a buff after system rules are normalized |
| flaminga | 3 | fighter | 44.4% | 48.2% | 90 | **healthy** | keep values and monitor after system-rule fixes |
| frajdzia | 3 | duelist | 94.4% | 60.7% | 90 | **overpowered** | review for a nerf after system rules are normalized |
| galanonim | 5 | fighter | 75.0% | 63.3% | 100 | **overpowered** | review for a nerf after system rules are normalized |
| grzalcia | 3 | mage | 11.1% | 41.5% | 90 | **underpowered** | review for a buff after system rules are normalized |
| hikki | 2 | fighter | 50.0% | 48.2% | 100 | **healthy** | keep values and monitor after system-rule fixes |
| hyodo888 | 2 | defender | 30.0% | 44.0% | 100 | **underpowered** | review for a buff after system rules are normalized |
| igor_janik | 3 | fighter | 50.0% | 49.1% | 90 | **healthy** | keep values and monitor after system-rule fixes |
| jaskol95 | 2 | duelist | 100.0% | 48.6% | 100 | **overpowered** | review for a nerf after system rules are normalized |
...
| laylo | 5 | mage | 20.0% | 51.4% | 100 | **underpowered** | review for a buff after system rules are normalized |
| maxas12 | 1 | fighter | 90.0% | 42.1% | 100 | **overpowered** | review for a nerf after system rules are normalized |
| merex | 4 | defender | 0.0% | 46.1% | 80 | **underpowered** | review for a buff after system rules are normalized |
| miki | 3 | duelist | 83.3% | 53.3% | 90 | **overpowered** | review for a nerf after system rules are normalized |
| mrozu | 1 | fighter | 65.0% | 43.3% | 100 | **overpowered** | review for a nerf after system rules are normalized |
| mrvlook | 1 | defender | 25.0% | 39.5% | 100 | **underpowered** | review for a buff after system rules are normalized |
| neko | 4 | defender | 12.5% | 49.8% | 80 | **underpowered** | review for a buff after system rules are normalized |
| noname | 3 | fighter | 33.3% | 53.7% | 90 | **underpowered** | review for a buff after system rules are normalized |
| olaczka | 5 | fighter | 60.0% | 57.1% | 100 | **healthy** | keep values and monitor after system-rule fixes |
| olsak | 1 | defender | 25.0% | 38.7% | 100 | **underpowered** | review for a buff after system rules are normalized |
| operatorkosiarki | 4 | duelist | 68.8% | 59.2% | 80 | **overpowered** | review for a nerf after system rules are normalized |
| pan_yakuza | 5 | fighter | 60.0% | 50.7% | 100 | **healthy** | keep values and monitor after system-rule fixes |
| pepe | 1 | mage | 0.0% | 32.6% | 100 | **underpowered** | review for a buff after system rules are normalized |
| piwniczak | 2 | mage | 0.0% | 33.7% | 100 | **underpowered** | review for a buff after system rules are normalized |
| puszmen12 | 4 | duelist | 93.8% | 65.6% | 80 | **overpowered** | review for a nerf after system rules are normalized |
| rafcikd | 1 | defender | 45.0% | 37.4% | 100 | **healthy** | keep values and monitor after system-rule fixes |
...
| szachowymentor | 5 | mage | 0.0% | 53.4% | 100 | **underpowered** | review for a buff after system rules are normalized |
| szalwia | 5 | fighter | 65.0% | 62.8% | 100 | **overpowered** | review for a nerf after system rules are normalized |
| turboglovica | 3 | mage | 0.0% | 46.2% | 90 | **underpowered** | review for a buff after system rules are normalized |
| un4given | 1 | defender | 10.0% | 41.0% | 100 | **underpowered** | review for a buff after system rules are normalized |
| v7 | 1 | fighter | 65.0% | 45.6% | 100 | **overpowered** | review for a nerf after system rules are normalized |
| vitas | 3 | fighter | 27.8% | 50.7% | 90 | **underpowered** | review for a buff after system rules are normalized |
| wodazlodowca | 2 | defender | 10.0% | 43.8% | 100 | **underpowered** | review for a buff after system rules are normalized |
| wrzechu | 4 | duelist | 68.8% | 60.1% | 80 | **overpowered** | review for a nerf after system rules are normalized |
| wu_hao | 2 | fighter | 45.0% | 49.2% | 100 | **healthy** | keep values and monitor after system-rule fixes |
| xntentacion | 1 | defender | 45.0% | 44.3% | 100 | **healthy** | keep values and monitor after system-rule fixes |
| yossarian | 5 | mage | 40.0% | 49.3% | 100 | **healthy** | keep values and monitor after system-rule fixes |

## Role and cost results

| Group | Appearances | Wins | Win rate |
|---|---:|---:|---:|
| role: defender | 3082 | 1362 | 44.2% |
| role: duelist | 3554 | 2063 | 58.0% |
| role: fighter | 5816 | 2950 | 50.7% |
| role: mage | 2548 | 1125 | 44.2% |
| cost: 1 | 3139 | 1316 | 41.9% |
| cost: 2 | 3199 | 1463 | 45.7% |
| cost: 3 | 2852 | 1470 | 51.5% |
| cost: 4 | 2634 | 1466 | 55.7% |
| cost: 5 | 3176 | 1785 | 56.2% |
...
| XN KGB | 4 | 9 | 20 | 15 | 75.0% | 25.0% | 50.0% |
...
| Starokurwy | 3 | 4 | 20 | 4 | 20.0% | 80.0% | -60.0% |
...
| Normik | 1 | 2 | 20 | 1 | 5.0% | 95.0% | -90.0% |
| Normik | 2 | 4 | 20 | 1 | 5.0% | 95.0% | -90.0% |
| Normik | 3 | 5 | 20 | 4 | 20.0% | 80.0% | -60.0% |
