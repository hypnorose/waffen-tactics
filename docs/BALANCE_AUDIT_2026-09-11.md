...
- Raw machine-readable results: `docs\BALANCE_AUDIT_2026-09-11.json`.
- Re-run command: `python tools/balance_audit.py --generated-date 2026-09-11 --output-json docs\BALANCE_AUDIT_2026-09-11.json --output-md docs\BALANCE_AUDIT_2026-09-11.md`.
