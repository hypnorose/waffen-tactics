...
echo ""
echo "Documentation:"
echo "  - docs/EVENT_REPLAY_TESTING.md (canonical replay/desync guide)"
echo "  - docs/COMBAT_RUNTIME_BOUNDARY.md (runtime ownership boundary)"
echo "  - docs/RELEASE_VALIDATION_GATE.md (release checklist)"
echo ""
