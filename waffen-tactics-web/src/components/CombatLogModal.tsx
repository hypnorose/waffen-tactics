...
export default function CombatLogModal({ showLog, visible = true, setShowLog, combatLog, logEndRef }: CombatLogModalProps) {
  ...
  return (
    <div className="combat-log-modal" aria-hidden={!visible} style={{ position: 'fixed', top: 80, right: 40, width: 600, height: 600, background: '#0f172a', border: '2px solid #475569', borderRadius: 12, zIndex: 200, boxShadow: '0 8px 32px rgba(0,0,0,0.7)', display: visible ? 'flex' : 'none', flexDirection: 'column' }}>
